...
public class Wlmwldata implements Serializable {
    ...
    public String toString() {
        return "Wlmwldata{" + "id=" + getId() + ", createdt='" + getCreatedt() + "'" + ", updatedt='" + getUpdatedt()
                + "'" + ", createusr=" + getCreateusr() + ", updateusr=" + getUpdateusr() + ", wfstate='" + getWfstate()
                + "'" + ", wfprocid=" + getWfprocid() + ", namedata='" + getNamedata() + "'" + ", addressdata='"
                + getAddressdata() + "'" + ", citydata='" + getCitydata() + "'" + ", countrydata='" + getCountrydata()
                + "'" + ", birthdatedata='" + getBirthdatedata() + "'" + ", tinnumberdata='" + getTinnumberdata() + "'"
                + "}";
    }
}
